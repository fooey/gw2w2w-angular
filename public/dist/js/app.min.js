/*! grunt-uglify gw2w2w-angular - v0.0.1 - 2014-05-17 */
...
*
!*/
angular.module("gw2app").directive("pieChart",function(){function a(a,b){var c=(a.size,a.strokewidth,a.scores),d=$("<img />",{"class":"pieChart"}).hide(),e=$("<i>",{"class":"fa fa-spinner fa-spin chartLoading"}).hide();b.append(d).append(e),a.$watch("scores",function(a){c!==a&&a&&a.length?(c=a,e.hide(),d.show().attr("src","http://piely.net/60/"+c.join(",")+"?strokeWidth=2")):a||e.fadeIn()})}return{scope:{scores:"=scores",size:"=size",strokewidth:"=strokewidth"},restrict:"E",link:a}}),angular.module("gw2app").directive("gw2Objective",[function(){function a(a){function b(b,c){f[b]=a.$watch(b,function(d){d&&(a[c]=a.isStatic?_.cloneDeep(d):d,a.isStatic&&e(b))})}function c(){return d(Date.now())}function d(a){return 1e3*Math.round(a/1e3)}function e(a){f[a]&&f[a]()}a.isStatic=angular.isDefined(a.isStatic)?a.isStatic:!1;var f={};b("watchedObjective","objective"),b("watchedState","state"),b("watchedGuild","guild"),a.getDirectionArrow=function(a){var b=["/dist/img/min/arrow"];return a.n?b.push("north"):a.s&&b.push("south"),a.w?b.push("west"):a.e&&b.push("east"),b.join("-")+".svg"};var g=3e5;a.buffTimer=_.throttle(function(){return a.state?a.state.lastCaptured+g-c():0},1e3/3)}return{scope:{columns:"=columns",langKey:"=langKey",watchedObjective:"=objective",watchedState:"=state",watchedGuild:"=guild",timestamp:"=?timestamp",isStatic:"=?isStatic",mapName:"=?mapName",descriptionType:"=?descriptionType"},restrict:"E",link:a,templateUrl:"/partials/tracker-objective"}}]),/*!
 *
 *	Services - CacheSvc
 *
 !*/
 ...
 *
 !*/
angular.module("gw2app").controller("TrackerCtrl",["$scope","$anchorScroll","$window","$interval","$timeout","GW2Svc","i18nSvc",function(a,b,c,d,e,f,g){"use strict";function h(){a.$watch(function(){return a.matchDetails[a.active.matchId]},function(b){a.active.matchDetails=b})}function i(b){var c=a.active.world.id;async.detect(a.matches,function(a,b){b(a.blue_world_id===c||a.green_world_id===c||a.red_world_id===c)},function(c){a.matchId&&(a.prevMatchId=a.matchId),a.active.match=c,a.active.matchId=c.wvw_match_id,a.matchId=c.wvw_match_id,b()})}function j(b){a.logFilters={map:"all",captures:!0,claims:!0},a.moment=c.moment,a.timersAccurate=!1,B(),o(),m(),a.mapNamesByType={Center:"Eternal Battlegrounds",RedHome:a.matchWorldsByColor.red[a.active.lang.slug].name,BlueHome:a.matchWorldsByColor.blue[a.active.lang.slug].name,GreenHome:a.matchWorldsByColor.green[a.active.lang.slug].name},a.state={},a.guilds={},a.timeline=[],a.matchGuilds={},console.log("Scope Inited"),b()}function k(b){var c=[a.active.world.name,"@","GuildWars2 WvW",g.liveScores[a.active.lang.slug]];"en"!==a.active.lang.slug&&c.push("("+a.active.lang.name+")"),a.setPageTitle(c.join(" "),b)}function l(b){a.matchWorlds=[a.worldsById[a.active.match.red_world_id],a.worldsById[a.active.match.blue_world_id],a.worldsById[a.active.match.green_world_id]],a.matchWorldsByColor={red:a.worldsById[a.active.match.red_world_id],blue:a.worldsById[a.active.match.blue_world_id],green:a.worldsById[a.active.match.green_world_id]},b()}function m(){var b={castles:0,keeps:0,towers:0,camps:0,tick:0};a.holdings={red:_.clone(b),blue:_.clone(b),green:_.clone(b)}}function n(b,c,d){if(b&&!angular.equals(b,c)){var e=r(b);m(),_.each(e,function(b){var c=a.gw2.wvw.objectiveMeta[b.id];if(c){var d=a.gw2.wvw.objectiveTypes[c.type],e=b.owner.toLowerCase();1===c.type?a.holdings[e].castles++:2===c.type?a.holdings[e].keeps++:3===c.type?a.holdings[e].towers++:4===c.type&&a.holdings[e].camps++,a.holdings[e].tick+=d.value}})}d()}function o(){var b=document.createElement("audio");b.setAttribute("src","/dist/audio/beep-27.mp3"),a.audioEnabled=!1,a.toggleAudio=function(){a.audioEnabled=!a.audioEnabled},a.playNotificationSound=_.throttle(function(){a.audioEnabled&&b.play()},500)}function p(a,b){async.parallel([v.bind(null,a),s.bind(null,a,b),n.bind(null,a,b)])}function q(b){a.objectives=f.data.wvw.objectives,b()}function r(a){var b=_.flatten(_.pluck(a.maps,"objectives")),c={};return angular.forEach(b,function(a){c[a.id]=a}),c}function s(b,c,d){b||c||d(),a.matchStateIntialized=a.matchStateIntialized||!1,!b||c||a.matchStateIntialized||(a.matchStateIntialized=!0,t(b,d)),b&&c&&F(b,c,d)}function t(b,c){var d=D(a.initTime),e=r(b);angular.forEach(e,function(b){b.initTime=d,b.lastCaptured=b.initTime,b.owner_guild?(b.lastClaimed=d,x(b.lastCaptured,b.owner_guild,b.id)):a.objectives[b.id]&&a.objectives[b.id].guild&&delete a.objectives[b.id].guild,a.state[b.id]=b}),c()}function u(b,c,d){var e=r(b),f=r(c),g=C();angular.forEach(a.objectives,function(b){if(b.meta&&b.meta.timer){var c=a.state[b.id],d=f[b.id],h=e[b.id],i=d.owner!==h.owner,j=d.owner_guild!==h.owner_guild,k=!!h.owner_guild;if(i||j){var l=b.name[a.active.lang.slug];i&&(console.log(g,"newOwner"),c.owner=h.owner,c.prevOwner=d.owner,c.lastCaptured=g,delete c.owner_guild,y(g,"newOwner",h)),j&&(c.owner_guild=h.owner_guild,k?(console.log(g,"newClaimer"),c.lastClaimed=g,y(g,"newClaimer",h),x(g,h.owner_guild,h.id)):console.log(g,"************ dropClaimer")),a.playNotificationSound(),console.log(g,l,c,d,h)}}}),d()}function v(b,c){if(b){var d=r(b),e=_.pluck(d,"owner_guild");e=_.without(_.uniq(e),void 0);var f=Object.keys(a.guilds),g=_.difference(e,f);async.each(g,w,c)}else c()}function w(b,c){f.getGuildDetails(b,function(d,e){a.guilds[b]=e,c()})}function x(b,c,d){var e=a.active.match.wvw_match_id,f=a.matchGuilds[e]=a.matchGuilds[e]||{};f[c]||(f[c]={id:c,claims:[],latestClaim:b}),f[c].claims.push({id:d,timestamp:b}),angular.forEach(f[c].claims,function(a){f[c].latestClaim=Math.max(f[c].latestClaim,a.timestamp)}),f[c].latestClaimText=moment(f[c].latestClaim).format("dddd, MMMM Do YYYY, h:mm:ss a")}function y(b,c,d){var e=_.cloneDeep(d);a.timeline.push({type:c,objective:e,timestamp:b}),a.timeline.length>=G&&console.log("timeline discard",a.timeline.shift())}function z(){async.parallel([A],angular.noop)}function A(b){var c=$(".objective .moment span");a.timeline&&a.timeline.length?async.each(c,function(a,b){var c=$(a),d=c.data("timestamp");c.text(moment(d).twitter()),b(null)},b):b()}function B(){var b=Date.now()-a.initTime,c=b>3e5;c?(console.log("Timers now accurate"),a.timersAccurate=!0):a.timers.__waitForAccurateTimers=e(B,1e3)}function C(){return D(Date.now())}function D(a){return 1e3*Math.round(a/1e3)}console.log("\nAPP MODE :: Tracker\n");var E=1;a.gotoGuild=function(a){$location.hash(a),b()},a.highlightObjective=function(a){$("#objective"+a).addClass("highlight")},a.deHighlightObjective=function(a){$("#objective"+a).removeClass("highlight")},a.getDirectionArrow=function(b){var c=a.gw2.wvw.objectiveMeta[b],d=["/dist/img/min/arrow"];return c.n?d.push("north"):c.s&&d.push("south"),c.w?d.push("west"):c.e&&d.push("east"),d.join("-")},a.$on("appInit",function(){console.log("TrackerCtrl Starting"),async.auto({setActiveMatch:i,setMatchWorlds:l,setObjectives:q,initScope:["setActiveMatch",j],setPageTitle:["setActiveMatch",k],getMatchDetails:["initScope",function(b){a.getMatchDetails(E,a.active.matchId,b)}],watchMatchDetails:["getMatchDetails",function(b){a.$watch("active.matchDetails",p),b()}]},function(){console.log("TrackerCtrl Ready"),h()})});var F=_.throttle(u,250),G=50;a.intervals.__updateTimers=d(z,1e3)}]);
